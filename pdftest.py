...
path = (r'D:\Derek\Documents\Dump\20200411-sitrep-82-covid-19.pdf')
...
pageObj1 = pdfReader.getPage(3)
pageObj2 = pdfReader.getPage(4)
pageObj3 = pdfReader.getPage(5)
pageObj4 = pdfReader.getPage(6)
pageObj5 = pdfReader.getPage(7)
pageObj6 = pdfReader.getPage(8)
...
pageObj = pageObj.replace('\n ','\t') # Replace new line with space for tab
...
with open(r'D:\Derek\Documents\Dump\report82.txt','w') as file_dump:
